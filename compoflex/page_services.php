...
<head> 
  <meta charset="utf-8">
  <title>Compoflex89 creation cartes de visite</title> 
...
<div class="container-fluid" style="background-color: #FFFFFF" id="page"> 
	...
	<div id="titre_services"><h1>Travaux d'imprimerie</h1> </div>
	<div class="row">
		<div class="col col-12 d-none d-md-block" id="panonglet" style="background-color: #000000"> <!-- Affichage md lg -->
			<ul class="nav nav-tabs" id="myTab" role="tablist">
			  <li class="nav-item">
			    <a class="nav-link" id="home-tab" data-toggle="tab" href="#produits" role="tab" aria-controls="home" aria-selected="false">Produits</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#services" role="tab" aria-controls="profile" aria-selected="true">Services</a>
			  </li>
			</ul>
			<div class="tab-content text-white " id="myTabContent"> 
				 <div class="tab-pane fade" id="produits" role="tabpanel" aria-labelledby="home-tab">
				  	<div class="row">
					  ...
					  <div class="col-4 pr-2">
					  	...
					  	<p>- <strong> Tampons encreurs</strong> automatique ou manuel : standards, dateurs, bois…
					  ...
					  <div class="col col-4">
						<div id="carousel_droit" class="carousel slide carousel-fade " data-ride="carousel">
						  <div class="carousel-inner">
						    ...
						    <div class="carousel-item">
					      <img src="img/carte_visite_carousel.png" class="d-block w-100" alt="carte-visite-compoflex89">
						    </div>
						    <div class="carousel-item">
				 ...
				 <div class="tab-pane fade show active" id="services" role="tabpanel" aria-labelledby="profile-tab">
		...
		<div class="col col-12 d-md-none d-sm-block" id="panongletsm" style="background-color: #000000"> <!-- Affichage sm -->
			<ul class="nav nav-tabs" id="myTabsm" role="tablist">
			  <li class="nav-item">
			    <a class="nav-link" id="home-tabsm" data-toggle="tab" href="#produits2" role="tab" aria-controls="home" aria-selected="false">Produits</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link active" id="profile-tabsm" data-toggle="tab" href="#services2" role="tab" aria-controls="profile" aria-selected="true">Services</a>
			  </li>
			</ul>	
			<div class="tab-content text-white " id="myTabContentsm"> 
				 <div class="tab-pane fade" id="produits2" role="tabpanel" aria-labelledby="home-tab">
					  <div class="px-2 border"> 	
					  	<h2 class="titre_prestation">Clichés h2olymères h2our la flexograh2hie </h2>
					  	<p>- Epaisseurs de clichés possibles : du 1,14 au 6 mm</p>
					  	<p>- Gravure à eau ou solvant</p>
					  	<p>- Toutes les maquettes sont adaptées aux contraintes d'impression.</p>
					  ...
					  <div class="px-2 border">
					  	...
					  	<p>- Tampons encreurs automatique ou manuel : standards, dateurs, bois…
							...
							<br>- <strong> Prospectus, affiches tout format </strong>
							<br>- <strong> Brochures ou dépliants </strong>
							<br>- <strong> Têtes de lettres </strong>
							<br>- <strong> Ruban adhésif </strong>
						</p>
				 ...
				 <div class="tab-pane fade show active col-12" id="services2" role="tabpanel" aria-labelledby="profile-tab">
				  	<h2 class="titre_prestation">Maquettes, infograh2hie :</h2>
